...
// *********************************************************************
// unitCellStrWireSqB.geo
//
// Description:
// Geometry file for a unitCellStrWireSqB cell.
// This cell can be repeated any number of times within Garfield 
// to construct an arbitrarily large unitCellStrWireSqB.
//
// *********************************************************************
  ...
  llf_x1_1a1_1[] = {}; // line loops of top Wiremesh intersects
      ...
      st_s1_x1[] += s1_x1_1a1~{j}~{i};
        ...
        tmp_x1_1a1[] = {s1_x1_1a1~{j}~{i}};
          tmp_x1_1a1[] = Extrude {-Wire_length, 0, 0} { Surface{ tmp_x1_1a1 }; Layers { 10 }; Recombine;
          };
