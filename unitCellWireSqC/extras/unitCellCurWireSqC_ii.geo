...
Total_Grid_size = 0.05;                         // Total grid size, in mm, 0.4
...
//  lcEtchingpillar = 0.001;
  lcCopperPlateBdry = 0.01;                     // characterization of mesh
...
Physical Volume(physvol_x1_wire) = { vt_x1_1a1[], vt_x1_1a2[] };
...
Physical Volume(physvol_y1_wire) = { vt_y1_2a1[], vt_y1_2a2[] };
...
// Second set of wires
  ...
  llf_x2_1b1_1[] = {}; // line loops of top Wiremesh intersects
      ...
      st_s1_x2[] += s1_x2_1b1~{j}~{i};
        ...
        tmp_x2_1b1[] = {s1_x2_1b1~{j}~{i}};
          tmp_x2_1b1[] = Extrude {{0,0,0},{0,-1,0},{-2*p+4*(i-1)*p+4*k*p,4*(j-1)*p+2*l*p,-R+r_w}, alpha} {
  ...
  llf_x2_1b2_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_x2_1b2[] = {tmp_x2_1b1[0]};
          tmp_x2_1b2[] = Extrude {{0,0,0},{0,1,0},{-2*p+4*(i-1)*p+2*k*p,4*(j-1)*p+l*p,R-r_w}, alpha} {
...
Physical Volume(physvol_x2_wire) = { vt_x2_1b1[], vt_x2_1b2[] };

// Delete{ Point{ p0_x2_1b1~{j}~{i} }; Point{ p1_x2_1b1~{j}~{i} }; Point{ p2_x2_1b1~{j}~{i} }; Point{ p3_x2_1b1~{j}~{i} }; Point{ p4_x2_1b1~{j}~{i} }; Line{ l1_x2_1b1~{j}~{i} }; Line{ l2_x2_1b1~{j}~{i} }; Line{ l3_x2_1b1~{j}~{i} }; Line{ l4_x2_1b1~{j}~{i} }; Surface{ s1_x2_1b1~{j}~{i} }; }
...
// Delete{ Volume{ v_x2_1b2[] }; Volume{ tmp_x2_1b2[1] }; Volume{ vt_x2_1b2[] }; Surface{ s_x2_1b2[] }; Surface{ tmp_x2_1b2[{2:5}] }; Surface{ st_x2_1b2[] }; Surface{ sf_x2_1b2[] }; }
  ...
  llf_y2_2b1_1[] = {}; // line loops of top Wiremesh intersects
      ...
      st_s1_y2[] += s1_y2_2b1~{j}~{i};
        ...
        tmp_y2_2b1[] = {s1_y2_2b1~{j}~{i}};
          tmp_y2_2b1[] = Extrude {{0,0,0},{-1,0,0},{4*(j-1)*p+2*l*p,4*(i-1)*p+4*k*p-2*p,R-r_w}, alpha} {
  ...
  llf_y2_2b2_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_y2_2b2[] = {tmp_y2_2b1[0]};
          tmp_y2_2b2[] = Extrude {{0,0,0},{1,0,0},{4*(j-1)*p+2*l*p,2*p-4*p+4*(i-1)*p+4*k*p-2*p,-R+r_w}, alpha} {
...
Physical Volume(physvol_y2_wire) = { vt_y2_2b1[], vt_y2_2b2[] };

// Delete{ Point{ p0_y2_2b1~{j}~{i} }; Point{ p1_y2_2b1~{j}~{i} }; Point{ p2_y2_2b1~{j}~{i} }; Point{ p3_y2_2b1~{j}~{i} }; Point{ p4_y2_2b1~{j}~{i} }; Line{ l1_y2_2b1~{j}~{i} }; Line{ l2_y2_2b1~{j}~{i} }; Line{ l3_y2_2b1~{j}~{i} }; Line{ l4_y2_2b1~{j}~{i} }; Surface{ s1_y2_2b1~{j}~{i} }; }
...
// Corner 1
// *******************************
pc1_1 = newp; Point(pc1_1) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, tD/2,lcCopperPlateBdry};
pc2_1 = newp; Point(pc2_1) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, -1*tD/2,lcCopperPlateBdry};
pc3_1 = newp; Point(pc3_1) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, (2*tC+tD)/2,lcCopperPlateBdry};
pc4_1 = newp; Point(pc4_1) = {0+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, -1*(2*tC+tD)/2,lcCopperPlateBdry};

// *******************************
// Corner 2
// *******************************
pc1_2 = newp; Point(pc1_2) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, tD/2,lcCopperPlateBdry};
pc2_2 = newp; Point(pc2_2) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, -1*tD/2,lcCopperPlateBdry};
pc3_2 = newp; Point(pc3_2) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, (2*tC+tD)/2,lcCopperPlateBdry};
pc4_2 = newp; Point(pc4_2) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, -1*(2*tC+tD)/2,lcCopperPlateBdry};

// *******************************
// Corner 3
// *******************************
pc1_3 = newp; Point(pc1_3) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, tD/2,lcCopperPlateBdry};
pc2_3 = newp; Point(pc2_3) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, -1*tD/2,lcCopperPlateBdry};
pc3_3 = newp; Point(pc3_3) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, (2*tC+tD)/2,lcCopperPlateBdry};
pc4_3 = newp; Point(pc4_3) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, -1*(2*tC+tD)/2,lcCopperPlateBdry};

// *******************************
// Corner 4
// *******************************
pc1_4 = newp; Point(pc1_4) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, tD/2,lcCopperPlateBdry};
pc2_4 = newp; Point(pc2_4) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, -1*tD/2,lcCopperPlateBdry};
pc3_4 = newp; Point(pc3_4) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, (2*tC+tD)/2,lcCopperPlateBdry};
...
ptmc_1 = newp; Point(ptmc_1) = {geo_f_x*a/2+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, (2*tC+tD)/2, lcCopperPlateBdry};
ptmd_1 = newp; Point(ptmd_1) = {geo_f_x*a/2+geo_f_x*m_1*a, geo_f_y*0+geo_f_y*n_1*a, tD/2, lcCopperPlateBdry};

ptmc_2 = newp; Point(ptmc_2) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*a/2+geo_f_y*n_1*a, (2*tC+tD)/2, lcCopperPlateBdry};
ptmd_2 = newp; Point(ptmd_2) = {geo_f_x*a+geo_f_x*m_1*a, geo_f_y*a/2+geo_f_y*n_1*a, tD/2, lcCopperPlateBdry};

ptmc_3 = newp; Point(ptmc_3) = {geo_f_x*a/2+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, (2*tC+tD)/2, lcCopperPlateBdry};
ptmd_3 = newp; Point(ptmd_3) = {geo_f_x*a/2+geo_f_x*m_1*a, geo_f_y*a+geo_f_y*n_1*a, tD/2, lcCopperPlateBdry};

ptmc_4 = newp; Point(ptmc_4) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*a/2+geo_f_y*n_1*a, (2*tC+tD)/2, lcCopperPlateBdry};
ptmd_4 = newp; Point(ptmd_4) = {geo_f_x*0+geo_f_x*m_1*a, geo_f_y*a/2+geo_f_y*n_1*a, tD/2, lcCopperPlateBdry};
...
// sl_dielectric = newreg; Surface Loop(newreg) = { surf_top_gas1[], surf_top_gas2[], surf_top_gas3[], surf_top_gas4[], surf_top_gas5[], surf_cyl_dielectric[], surf_bottom_cp1b[] }; // surf_lower_cp[],
// total_sl_dielectric[] += sl_dielectric;

sl_gas = newreg; Surface Loop(newreg) = { surf_top_cp[], ps_side_gas1a, ps_side_gas2a, ps_side_gas3a, ps_side_gas4a, ps_side_gas1b, ps_side_gas2b, ps_side_gas3b, ps_side_gas4b, ps_bsurf1, ps_bsurf2, ps_bsurf3, ps_bsurf4, ps_bsurf5, ps_bsurf6, ps_bsurf7, pscp_up_border1, pscp_up_border2, pscp_up_border3, pscp_up_border4, st_s1_x1[], st_x1_1a1[], st_x1_1a2[], st_tmp_x1[], st_s1_x2[], st_x2_1b1[], st_x2_1b2[], st_tmp_x2[], st_s1_y1[], st_y1_2a1[], st_y1_2a2[], st_tmp_y1[], st_s1_y2[], st_y2_2b1[], st_y2_2b2[], st_tmp_y2[] }; // surf_top_gas1[], surf_top_gas2[], surf_top_gas3[], surf_top_gas4[], surf_top_gas5[], 
// surf_cyl_dielectric[],
total_sl_gas[] += sl_gas;

sl_lower_cp = newreg; Surface Loop(newreg) = { surf_top_cp[], surf_bottom_cp[], pscp_low_border1, pscp_low_border2, pscp_low_border3, pscp_low_border4 }; // surf_lower_cp[],
...
// Physical Surface(physsurf_gas) = { surf_top_cp[], surf_top_gas1[], surf_top_gas2[], 
// surf_top_gas3[], surf_top_gas4[], surf_top_gas5[], surf_cyl_dielectric[], ps_side_gas1a, 
// ps_side_gas2a, ps_side_gas3a, ps_side_gas4a, ps_side_gas1b, ps_side_gas2b, ps_side_gas3b, 
// ps_side_gas4b, ps_bsurf1, ps_bsurf2, ps_bsurf3, ps_bsurf4, ps_bsurf5, ps_bsurf6, ps_bsurf7, 
