//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
/// MMGAS_STR_WIRE COMPONENT LABEL MODULE
...
physsurf_x1_wire = 750000;     	// + 1000 * i + j - steel wire surface area - mesh surface area - dirichlet boundary
physsurf_y1_wire = 760000;     	// + 1000 * i + j - steel wire surface area - mesh surface area - dirichlet boundary
physsurf_x2_wire = 770000;     	// + 1000 * i + j - steel wire surface area - mesh surface area - dirichlet boundary
physsurf_y2_wire = 780000;     	// + 1000 * i + j - steel wire surface area - mesh surface area - dirichlet boundary

physsurf_wire = 790000;		   	// + 1000 * i + j - wire surface area - mesh surface area - dirichlet boundary
// physsurf_wire_i= 800000;	   	// + 1000 * i + j - wire surface area - mesh surface area - dirichlet boundary
...
// physvol_gas_i = 970000;         // + 1000 * i + j - gas volume
