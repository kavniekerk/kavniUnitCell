...
//  lcEtchingpillar = 0.001;
  lcCopperPlateBdry = 0.001;                    // characterization of mesh
  lcExtElectrodeBdry = 0.001;
  LcWiremesh = 0.001;                            
...
// ps_lower_cp1 = newreg; Ruled Surface(newreg) = {llcp_low_rim_1a~{m}~{n}};
// surf_lower_cp[] += ps_lower_cp1;
// ps_lower_cp2 = newreg; Ruled Surface(newreg) = {llcp_low_rim_1b~{m}~{n}};
// surf_lower_cp[] += ps_lower_cp2;
// ps_lower_cp3 = newreg; Ruled Surface(newreg) = {llcp_low_rim_1c~{m}~{n}};
// surf_lower_cp[] += ps_lower_cp3;
// ps_lower_cp4 = newreg; Ruled Surface(newreg) = {llcp_low_rim_1d~{m}~{n}};
...
// ps_cyl_dielectric1 = newreg; Ruled Surface(newreg) = {ll_cyl_dielectric1b~{m}~{n}};
...
// ps_cyl_dielectric2 = newreg; Ruled Surface(newreg) = {ll_cyl_dielectric2b~{m}~{n}};
...
// ps_cyl_dielectric3 = newreg; Ruled Surface(newreg) = {ll_cyl_dielectric3b~{m}~{n}}; 
...
// ps_cyl_dielectric4 = newreg; Ruled Surface(newreg) = {ll_cyl_dielectric4b~{m}~{n}};
...
// sl_gas = newreg; Surface Loop(newreg) = { surf_top_cp[], ps_side_gas1a, ps_side_gas2a, ps_side_gas3a, ps_side_gas4a, ps_side_gas1b, ps_side_gas2b, ps_side_gas3b, ps_side_gas4b, ps_bsurf1, ps_bsurf2, ps_bsurf3, ps_bsurf4, ps_bsurf5, ps_bsurf6, 
// ps_bsurf7, pscp_up_border1, pscp_up_border2, pscp_up_border3, pscp_up_border4, -st_s1_x1[], st_x1_1a1[], st_x1_1a2[], st_tmp_x1[], -st_s1_x2[], st_x2_1b1[], st_x2_1b2[], st_tmp_x2[], -st_s1_y1[], st_y1_2a1[], st_y1_2a2[], st_tmp_y1[], 
// -st_s1_y2[], st_y2_2b1[], st_y2_2b2[], st_tmp_y2[] }; // surf_top_gas1[], surf_top_gas2[], surf_top_gas3[], surf_top_gas4[], surf_top_gas5[], surf_cyl_dielectric[],
// total_sl_gas[] += sl_gas;
