...
// *********************************************************************
// unitCellStrWireSqA.geo
//
// Description:
// Geometry file for a unitCellStrWireSqA cell.
// This cell can be repeated any number of times within Garfield 
// to construct an arbitrarily large unitCellStrWireSqA.
//
// *********************************************************************
...
For i In {1:i_t_x}
  ...
  llf_x1_1b1_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_x1_1b1[] = {tmp_x1_1a2[0]};
          tmp_x1_1b1[] = Extrude {Wire_length, 0, 0} { Surface{ tmp_x1_1b1[0] }; Layers { 10 }; Recombine;
          };
  ...
  llf_x1_1b2_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_x1_1b2[] = {tmp_x1_1b1[0]};
          tmp_x1_1b2[] = Extrude {Wire_length, 0, 0} { Surface{ tmp_x1_1b2[0] }; Layers { 10 }; Recombine;
          };
...
For i In {1:i_t_y}
  ...
  llf_y1_2b1_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_y1_2b1[] = {tmp_y1_2a2[0]};
          tmp_y1_2b1[] = Extrude {0, Wire_length, 0} { Surface{ tmp_y1_2b1[0] }; Layers { 10 }; Recombine;
          };
  ...
  llf_y1_2b2_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_y1_2b2[] = {tmp_y1_2b1[0]};
          tmp_y1_2b2[] = Extrude {0, Wire_length, 0} { Surface{ tmp_y1_2b2[0] }; Layers { 10 }; Recombine;
          };
...
For i In {1:i_t_x}
  ...
  llf_x2_1a1_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_x2_1a1[] = {tmp_x2_1b2[0]};
          tmp_x2_1a1[] = Extrude {Wire_length, 0, 0} { Surface{ tmp_x2_1a1 }; Layers { 10 }; Recombine;
          };
  ...
  llf_x2_1a2_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_x2_1a2[] = {tmp_x2_1a1[0]};
          tmp_x2_1a2[] = Extrude {Wire_length, 0, 0} { Surface{ tmp_x2_1a2[0] }; Layers { 10 }; Recombine;
          };
...
For i In {1:i_t_y}
  ...
  llf_y2_2a1_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_y2_2a1[] = {tmp_y2_2b2[0]};
          tmp_y2_2a1[] = Extrude {0, Wire_length, 0} { Surface{ tmp_y2_2a1[0] }; Layers { 10 }; Recombine;
          };
  ...
  llf_y2_2a2_1[] = {}; // line loops of top Wiremesh intersects
        ...
        tmp_y2_2a2[] = {tmp_y2_2a1[0]};
          tmp_y2_2a2[] = Extrude {0, Wire_length, 0} { Surface{ tmp_y2_2a2[0] }; Layers { 10 }; Recombine;
          };
